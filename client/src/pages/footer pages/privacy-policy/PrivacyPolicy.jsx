function PrivacyPolicy() {
  return (
    <div className="w-[60%] h-[80vh] overflow-y-scroll mx-auto mt-8 bg-white p-8 rounded-lg shadow-md">
      ...
      <p>
        TastyGo ("we", "us", or "our") is committed to protecting your personal
        information and respecting your privacy. This Privacy Policy explains
        how we collect, use, and share your personal data when you use our food
        delivery services through the TastyGo website (the "Service"). By using
      ...
      <p>
        ...
        track user activity, and analyze our website’s performance.
      </p>
      ...
      <p>
        ...
        purposes outlined in this Privacy Policy, such as processing
        transactions and complying with legal obligations.
      </p>
      ...
      <p>
        TastyGo is not intended for use by individuals under the age of 13. We
        ...
        contact us, and we will delete the information.
      </p>
